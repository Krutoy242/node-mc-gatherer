export default function addRecipes(
  ...
  const seedTiers: { [name: string]: [number, string?] } = {
    weed: [0],
    beetroots: [1, 'beetroot:0'],
    pumpkin: [1, 'pumpkin_seeds:0'],
    wheat: [1, 'wheat_seeds:0'],
    blackthorn: [2],
    brown_mushroom: [2, 'brown_mushroom:0'],
    carrots: [2, 'carrot:0'],
    cyazint: [2],
    dandelion: [2, 'yellow_flower:0'],
    flax: [2],
    melon: [2, 'melon_seeds:0'],
    potato: [2, 'potato:0'],
    red_mushroom: [2, 'red_mushroom:0'],
    reed: [2, 'reeds:0'],
    rose: [2, 'red_flower:0'],
    tulip: [2],
    cocoa: [3, 'dye:3'],
  ...
  Object.entries(seedTiers).forEach(([name, [tier, vanilla]]) =>
    addRecipe(`ic2:crop_seed_bag:0:{owner:"ic2",scan:1b,growth:1b,id:"${name}",resistance:1b,gain:1b}`, [
      `${(tier + 1) ** 3 * 100}x placeholder:ticks`,
